...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/checkout" method="POST" id="checkoutForm">
                ...
                <c:choose>
                    <c:when test="${not empty indirizzi}">
                        <div class="radio-group">
                            <input type="radio" name="opzioneIndirizzo" value="esistente" id="usaEsistente" checked>
                            <label for="usaEsistente">Usa un indirizzo esistente</label>
                            <select name="indirizzoId" style="margin-top: 10px;">
                                <option value="">-- Seleziona un indirizzo --</option>
                                <c:forEach var="ind" items="${indirizzi}">
                                    <option value="${ind.id}">
                                        ${ind.via} ${ind.civico}, ${ind.citta} (${ind.provincia}) - ${ind.cap}
                                    </option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="radio-group">
                            <input type="radio" name="opzioneIndirizzo" value="nuovo" id="usaNuovo">
                            <label for="usaNuovo">Usa un nuovo indirizzo</label>
                        </div>
                        
                        <div id="nuovoIndirizzo" style="display: none;" class="indirizzo-nuovo">
                            <div class="row">
                                <div>
                                    <label>Via *</label>
                            ...
                            <div class="row">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="provincia" maxlength="2" placeholder="es. RM">
                                </div>
                                <div>
                                    <label>CAP *</label>
                                    <input type="text" name="cap" maxlength="5" placeholder="es. 00100">
                                </div>
                            </div>
                        </div>
                    </c:when>
            ...
            <div class="section">
                ...
                <label>Seleziona come vuoi pagare *</label>
            ...
            <div class="section">
                ...
                <textarea name="notaCliente" rows="3" placeholder="Eventuali richieste o note..."></textarea>
            </div>
            ...
            <div class="section">
                ...
                <div class="total-box">
                    <div class="total-line">
                        ...
                        <span id="subtotale">€ ${String.format("%.2f", subtotale)}</span>
                    </div>
                    <div class="total-line">
                        <span>Spedizione:</span>
                        <span id="spedizione">€ ${String.format("%.2f", speseSpedizione)}</span>
                    </div>
                    <div id="contraccoltoRow" class="total-line" style="display: none;">
                        <span>Costo contrassegno:</span>
                        <span>€ 5.00</span>
                    </div>
                    <hr>
                    <div class="total-line total-final">
                        <span><strong>Totale da pagare:</strong></span>
                        <span id="totaleFinale"><strong>€ ${String.format("%.2f", totaleFinale)}</strong></span>
                    </div>
                </div>
            </div>
            ...
            <!-- BOTTONI -->
            <div class="actions">
                <a href="${pageContext.request.contextPath}/carrello" class="btn btn-secondary">← Torna al carrello</a>
    ...
    <script>
        ...
        var subtotale = ${subtotale};
        var speseSpedizione = ${speseSpedizione};
        var totaleBase = ${totaleFinale};
        ...
        function aggiornaTotali() {
            ...
            totaleSpan.innerHTML = '<strong>€ ' + nuovoTotale.toFixed(2) + '</strong>';
        }
        ...
        var selectIndirizzo = document.querySelector('select[name="indirizzoId"]');
