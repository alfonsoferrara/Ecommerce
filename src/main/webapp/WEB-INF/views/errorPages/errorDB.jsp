...
<title>Errore Database | CarryCrew</title>
...
<body>
	...
	<main class="error-container">
		<h1 class="error-code">ERRORE DATABASE</h1>
		<h2 class="error-title">Operazione non riuscita</h2>

		<div class="error-message">
			<p>Oops! Sembra che il database abbia restituito un messaggio di
				errore e che l'operazione non sia andata a buon fine!</p>
